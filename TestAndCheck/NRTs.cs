...
namespace TestAndCheck
{
    ...
    public class NRTs
    {
        public NRTs (int? validatedInteger, Inner? innerInstance, Inner notNullableInnerInstance)
        {
            this.validatedInteger = validatedInteger;
            this.innerInstance = innerInstance;
            this.notNullableInnerInstance = notNullableInnerInstance;
        }
        ...
        public void ExecuteTest()
        {
            ...
            notNullableInnerInstance = default;
            notNullableInnerInstance = default(Inner);
            #endregion
        ...
        public static void ExecuteTestDefaultOperator()
        {
            #region Kiểm tra toán tử default
            if (default(Inner) == null)
            {
                Console.WriteLine($"default(Inner) == null");
            }
            else
            {
                Console.WriteLine($"default(Inner) != null");
